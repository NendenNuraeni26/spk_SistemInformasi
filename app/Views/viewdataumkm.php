                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/home/formeditmbl/<?= $row->id_umkm; ?>" class="badge badge-primary">Edit</a>
                                                <a href="/home/deletembl/<?= $row->id_umkm; ?>" class="badge badge-danger">hps</a>
                                                <form action="/home/deletembl/<?= $row->id_umkm; ?>" method="post">
                                                    <?= csrf_field(); ?>
